...
<div class="diag-showcase">
  ...
  <section class="section">
    ...
    <div class="demo-block">
      ...
      <div class="demo-row">
        ...
        >
        <InteractiveChip active={chipActive} onclick={() => (chipActive = !chipActive)} count={7}
          >Alerts</InteractiveChip
        >
  ...
  <section class="section">
    ...
    <div class="btn-group">
      ...
      <button class="btn toast-error" onclick={() => toast.error('Connection to service timed out.')}
        >Error toast</button
      >
